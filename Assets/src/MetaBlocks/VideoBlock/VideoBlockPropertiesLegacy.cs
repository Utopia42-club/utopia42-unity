...
{
    [System.Serializable]
    public class VideoBlockPropertiesLegacy : ICloneable
    {
        ...
        public VideoBlockPropertiesLegacy()
        {
        }

        public VideoBlockPropertiesLegacy(VideoBlockPropertiesLegacy obj)
        {
            if (obj != null)
            {
                left = obj.left;
        ...
        public override bool Equals(object obj)
        {
            ...
            if ((obj == null) || !this.GetType().Equals(obj.GetType()))
                return false;
            var prop = obj as VideoBlockPropertiesLegacy;
        ...
        public object Clone()
        {
            return new VideoBlockPropertiesLegacy()
            {
                left = left?.Clone(),
                right = right?.Clone(),
                top = top?.Clone(),
